...
export const adminUpdateEducation = (contentId: string, data: any) => api.put(`/admin/education/${contentId}`, data);
export const adminDeleteEducation = (contentId: string) => api.delete(`/admin/education/${contentId}`);
