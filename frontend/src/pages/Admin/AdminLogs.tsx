  ...
  return (
    <div className="p-8">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold mb-1">Auditoría de Administración</h2>
          <p className="text-sm text-gray-400 max-w-2xl">
            Aquí se registran todas las acciones realizadas por los administradores: eliminación de usuarios,
            actualizaciones, bloqueos y otras operaciones críticas.
          </p>
        </div>
        <button
          onClick={fetchLogs}
